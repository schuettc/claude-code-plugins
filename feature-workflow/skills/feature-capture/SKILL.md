...
3. **`/feature-implement [id]`** - Writes code following the plan
4. **`/feature-submit [id]`** - Creates feature branch, opens draft PR, triggers external review
5. **`/feature-submit [id] --respond`** - Addresses review feedback (repeat as needed)
